...
public:
	...
	Revizie(const Revizie &r)
	{
		this->numar_revizie=r.numar_revizie;
		this->numar_kilometri=r.numar_kilometri;
		strcpy(this->data,r.data);
		this->numar_operatii=r.numar_operatii;
		this->operatii = new Operatie[r.numar_operatii];
		for(int i=0;i<r.numar_operatii;i++)
			this->operatii[i]=r.operatii[i];
	}
	Revizie &operator=(Revizie &r)
	{
		this->numar_revizie=r.numar_revizie;
		this->numar_kilometri=r.numar_kilometri;
		strcpy(this->data,r.data);
